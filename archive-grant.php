...
?>
	...
	<main id="primary" class="site-main">
		<article>
			<div class="gas_hero space_2 container">
				<div class="left">
					<h1>
						<?php if($title) {
							echo $title;
			 ...
			 <div class="gas_grid container space_2" id="opportunities">
                <?php
                // Query for grants-awards posts
                $grant_award_query = new WP_Query(array(
                    'post_type' => ['grant','award'],
                ...
                if ($grant_award_query->have_posts()) :
                    // Start the loop
                    while ($grant_award_query->have_posts()) : $grant_award_query->the_post();
                        ...
                        <div class="gas_item">
                            <div class="gas_item_content">
                                <h3 class="gas_item_title title-3">
                                    <?php if($gi_title) {
                                        echo $gi_title;
                                    } else {
                                        the_title();
                                ...
                                <?php if ($description) : ?>
                                <div class="gas_item_description">
                                    <?php echo wp_kses_post($description); ?>
                                </div>
                                <?php endif; ?>

                                <?php if ($deadline && strtotime($deadline) > time()) : ?>
                                <div class="gas_item_deadline">
                                ...
                                <div class="gas_item_button">
                                    <a href="<?php the_permalink(); ?>" class="btn-3">Learn More</a>
                                </div>
                            </div>

                            <div class="gas_item_image">
                                <?php
                ...
                <?php
                // Add page with ID 632 to the grid
                $page_632 = get_post(632);
                if ($page_632 && $page_632->post_status === 'publish') {
                    // Get ACF fields for the page
                    $gi_title = get_field('gh_title', 632);
                    $description = get_field('gh_description', 632);
                    $deadline = get_field('deadline', 632);
                    $grant_not_active = get_field('grant_not_active', 632);
                    ?>
                        ...
                        <div class="gas_item_content">
                            <h3 class="gas_item_title title-3">
                                <?php if($gi_title) {
                                    ...
                                    echo esc_html($page_632->post_title);
                                } ?>
                            </h3>
                            ...
                            <div class="gas_item_button">
                                <a href="<?php echo esc_url(get_permalink(632)); ?>" class="btn-3">Learn More</a>
                            </div>
                        </div>

                        <div class="gas_item_image">
                            <?php
                            if (has_post_thumbnail(632)) {
                                echo get_the_post_thumbnail(632);
                            } else {
                                // Display a default image if no featured image is set
                                echo '<img src="' . get_template_directory_uri() . '/assets/images/default-grant-award-image.jpg" alt="Default Grant Image">';
                            }
